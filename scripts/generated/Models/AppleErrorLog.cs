...
namespace BD.AppCenter.Ingestion.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("appleError")]
    public partial class AppleErrorLog : AbstractErrorLog
    {
        ...
        public override void Validate()
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "ApplicationPath");
            }
            if (OsExceptionType == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "OsExceptionType");
            }
            if (OsExceptionCode == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "OsExceptionCode");
            }
            if (OsExceptionAddress == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "OsExceptionAddress");
            }
            if (Threads != null)
            {
