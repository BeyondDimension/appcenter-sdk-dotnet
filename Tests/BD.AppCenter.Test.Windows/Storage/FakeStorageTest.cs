...
namespace BD.AppCenter.Test
{
    ...
    public class FakeStorageTest
    {
        ...
        public void ShutdownTimeout()
        {
            ...
            var storage = new BD.AppCenter.Storage.Storage(mockConnection.Object, It.IsAny<string>());
...
#pragma warning restore 4014
        ...
        public void GetLogsQueryError()
        {
            ...
            var fakeStorage = new BD.AppCenter.Storage.Storage(mockAdapter.Object, It.IsAny<string>());
