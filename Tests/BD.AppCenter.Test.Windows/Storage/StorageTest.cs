...
using BD.AppCenter.Storage;
using BD.AppCenter.Test.Windows.Utils;
...
namespace BD.AppCenter.Test.Windows.Storage
{
    [TestClass]
    public class StorageTest
    {
        ...
        public void TestInitialize()
        {
            ...
            BD.AppCenter.Utils.Constants.AppCenterDatabasePath = _databasePath;
            BD.AppCenter.Utils.Constants.AppCenterFilesDirectoryPath = Environment.CurrentDirectory;
            _storage = new BD.AppCenter.Storage.Storage();
        ...
        {
            BD.AppCenter.Utils.Constants.AppCenterDatabasePath = "";
            BD.AppCenter.Utils.Constants.AppCenterFilesDirectoryPath = "";
            try
            {
                _storage.DeleteLogs(StorageTestChannelName);
                _storage.WaitOperationsAsync(TimeSpan.FromSeconds(10)).Wait();
        ...
        public void TestDatabaseIsInitialized()
        {
            ...
            using (var storage = new BD.AppCenter.Storage.Storage(mockStorageAdapter, _databasePath))
            {
        ...
        public void FailToGetALog()
        {
            ...
            var storage = new BD.AppCenter.Storage.Storage(adapter, _databasePath);
