...
using BD.AppCenter.Crashes.Ingestion.Models;
using BD.AppCenter.Crashes.Utils;
using BD.AppCenter.Ingestion.Models;
using BD.AppCenter.Utils;
using BD.AppCenter.Utils.Files;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using Moq;

namespace BD.AppCenter.Crashes.Test.Windows
{
    [TestClass]
    public class CrashesTest
    {
        ...
        private readonly ManagedErrorLog _expectedManagedErrorLog = new ManagedErrorLog
        {
            ...
            Device = Mock.Of<BD.AppCenter.Ingestion.Models.Device>()
        };
        ...
        public void OnChannelGroupReadySendsFilteredPendingCrashes()
        {
            ...
            var mockErrorLogHelper = Mock.Of<ErrorLogHelper>();
            ErrorLogHelper.Instance = mockErrorLogHelper;
            var expectedManagedErrorLog1 = new ManagedErrorLog { Id = Guid.NewGuid(), ProcessId = ExpectedProcessId, AppLaunchTimestamp = DateTime.Now, Timestamp = DateTime.Now, Device = Mock.Of<BD.AppCenter.Ingestion.Models.Device>() };
            var expectedManagedErrorLog2 = new ManagedErrorLog { Id = Guid.NewGuid(), ProcessId = ExpectedProcessId, AppLaunchTimestamp = DateTime.Now, Timestamp = DateTime.Now, Device = Mock.Of<BD.AppCenter.Ingestion.Models.Device>() };
        ...
        public void LastSessionCrashReportWhenEnabledAndCrashOnDisk()
        {
            ...
            var mockErrorLogHelper = Mock.Of<ErrorLogHelper>();
            ErrorLogHelper.Instance = mockErrorLogHelper;
            var expectedRecentManagedErrorLog = new ManagedErrorLog { Id = Guid.NewGuid(), AppLaunchTimestamp = DateTime.Now, Timestamp = DateTime.Now, Device = new BD.AppCenter.Ingestion.Models.Device() };
            var expectedOldManagedErrorLog = new ManagedErrorLog { Id = Guid.NewGuid(), AppLaunchTimestamp = DateTime.Now.AddDays(-200), Timestamp = DateTime.Now.AddDays(-200), Device = new BD.AppCenter.Ingestion.Models.Device() };
        ...
        public void LastSessionCrashReportWhenMultipleCrashesAndRecentCrashIsInvalid()
        {
            ...
            var expectedOldErrorLog = new ManagedErrorLog { Id = Guid.NewGuid(), AppLaunchTimestamp = DateTime.Now.AddDays(-200), Timestamp = DateTime.Now.AddDays(-200), Device = new BD.AppCenter.Ingestion.Models.Device() };
