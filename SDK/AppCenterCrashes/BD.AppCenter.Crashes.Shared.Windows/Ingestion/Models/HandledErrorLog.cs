...
namespace BD.AppCenter.Crashes.Ingestion.Models
{
    ...
    public partial class HandledErrorLog : LogWithProperties
    {
        ...
        /// </param>
        public HandledErrorLog(BD.AppCenter.Ingestion.Models.Device device, Exception exception, System.DateTime? timestamp = default(System.DateTime?), System.Guid? sid = default(System.Guid?), string userId = default(string), string dataResidencyRegion = default(string), IDictionary<string, string> properties = default(IDictionary<string, string>), System.Guid? id = default(System.Guid?), IList<Binary> binaries = default(IList<Binary>))
