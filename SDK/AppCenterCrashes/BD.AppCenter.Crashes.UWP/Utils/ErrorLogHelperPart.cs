...
using BD.AppCenter.Crashes.Windows.Utils;
using System;
...
using ModelBinary = BD.AppCenter.Crashes.Ingestion.Models.Binary;
using ModelException = BD.AppCenter.Crashes.Ingestion.Models.Exception;
using ModelStackFrame = BD.AppCenter.Crashes.Ingestion.Models.StackFrame;
