// https://github.com/dotnet/winforms/blob/v5.0.4/src/System.Windows.Forms/src/System/Windows/Forms/Screen.cs
#if !NETFRAMEWORK
...
namespace System.Windows.Forms
{
    ...
    internal class Screen
    {
        ...
        private static readonly object syncLock = new();//used to lock this class before sync'ing to SystemEvents
        ...
        /// </summary>
        public static Screen FromPoint(PointInt32 point)
        {
            if (multiMonitorSupport)
            {
        ...
        ///  specified point.
        /// </summary>
        public static Rectangle GetWorkingArea(PointInt32 pt)
        {
        ...
        ///  point.
        /// </summary>
        public static Rectangle GetBounds(PointInt32 pt)
        {
